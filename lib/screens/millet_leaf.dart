...
class MilletLeaf extends StatefulWidget {
  const MilletLeaf({Key? key}) : super(key: key);

  @override
  State<MilletLeaf> createState() => _MilletLeafState();
}

class _MilletLeafState extends State<MilletLeaf> {
  // @override
  //
  // void dispose() {
  //   Hive.close();
              ...
              child: Column(
                children: [
                  AppBar(
                    ...
                    title: Text(appStrings!.milletLeaf),
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/capture_image", arguments: {"crop":"millet_leaf"});
                      setState(() {});
                    },
                    icon: Align(
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/load_image", arguments: {"crop":"millet_leaf"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/images_library", arguments: {"crop":"millet_leaf"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/disease_library", arguments: {"crop":"millet_leaf"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
