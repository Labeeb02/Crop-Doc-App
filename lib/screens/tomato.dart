            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/load_image", arguments: {"crop":"tomato"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/images_library", arguments: {"crop":"tomato"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/disease_library", arguments: {"crop":"tomato"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
