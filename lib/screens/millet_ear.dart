...
class MilletEar extends StatefulWidget {
  const MilletEar({Key? key}) : super(key: key);

  @override
  State<MilletEar> createState() => _MilletEarState();
}

class _MilletEarState extends State<MilletEar> {
  // @override
  // void dispose() {
  //   Hive.close();
  //   super.dispose();
              ...
              child: Column(
                children: [
                  AppBar(
                    ...
                    title: Text(appStrings!.milletEar),
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/capture_image", arguments: {"crop":"millet_ear"});
                      setState(() {});
                    },
                    icon: Align(
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/load_image", arguments: {"crop":"millet_ear"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/images_library", arguments: {"crop":"millet_ear"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      await Navigator.pushNamed(context, "/disease_library", arguments: {"crop":"millet_ear"});
                      setState(() {});
                    },
                    icon: Align(
                      alignment: Alignment.centerLeft,
